# this cleans the REPLICATION data. takes rep_catalog as catalog. produces a version of the catalog of papers without
#  the keywords used for searching each theory, in lower case, missing symbols and grammatical markers. produces
# rep_clean_catalog.txt#
...
text = open('rep_catalog.txt', 'r').read()
...
new_text = re.sub(r'[^\w\s]', '', new_text)  # removes punctuation and symbols
...
with open('rep_clean_catalog.txt', 'w') as outputdb:
