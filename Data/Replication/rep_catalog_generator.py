# This script produces the catalog of REPLICATION data. takes the various .txt of abstracts and their respective 
# theories specified in rep_file_key.txt and produces one big catalog of papers, assigning each an ID. Outputs it to 
# 'rep_catalog.txt'# 
