#this script takes the various .txt of abstracts and their respective theories specified in file_key.txt and produces one big catalog of papers, assigning each an ID. Outputs it to 'catalog.txt'#
