...
#this script produces a version of the catalog of papers without the keywords used for searching each theory, in lower case, missing symbols and grammatical markers.
