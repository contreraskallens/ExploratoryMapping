#this cleans the REPLICATION data. takes rep_catalog as catalog. produces a version of the catalog of papers without the keywords used for searching each theory, in lower case, missing symbols and grammatical markers. produces rep_clean_catalog.txt#
