# produces REPLICATION document by term. this script creates a document by (unique) term of the catalog specified as
# database (default: 'rep_lemmatized_catalog.txt'). Writes it down as 'rep_document_by_term.txt'#
